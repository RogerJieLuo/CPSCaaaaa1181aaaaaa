...
public class BoardComponent extends JComponent implements ReversiRule{
    ...
    public BoardComponent(ClientAndServer cas){
        this.cas = cas;
     ...
     */
    public void endGame(){
        // in order to play again the game, keep the listener
//        this.removeMouseListener(clickAction);
    }
    ...
    class ClickAction implements MouseListener{
        ...
        public void mouseReleased(MouseEvent e) {
            if(!enabled) {
                cas.setMsgText("You can't play right now.");
            }else {
